...
const FAILURE_KEYS: Readonly<Partial<Record<VerificationFailureCode, TranslationKey>>> = {
  ...
  "network-failure": "sourceOnboarding.failure.tikhubNetwork",
  "malformed-response": "sourceOnboarding.failure.tikhubMalformed",
  "profile-shape-unsupported": "sourceOnboarding.failure.tikhubProfileShape",
