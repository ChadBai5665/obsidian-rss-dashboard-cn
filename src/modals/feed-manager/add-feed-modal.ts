...
export class AddFeedModal extends Modal {
  ...
  private renderHeader() {
    new Setting(this.contentEl)
      .setName(this.t("modal.feed.addTitle"))
      .setHeading();
    const subtitle = this.contentEl.createDiv({ cls: "add-feed-subtitle" });
    subtitle.textContent = this.t("modal.feed.addDesc");
  }
  ...
  private renderFeedOptionsSection() {
    ...
    autoDeleteSetting.addDropdown((dropdown) => {
      dropdown
        ...
        .addOption("1", this.t("modal.feed.day"))
        .addOption("3", this.t("modal.feed.days", { count: 3 }))
        .addOption("7", this.t("modal.feed.week"))
        .addOption("14", this.t("modal.feed.weeks", { count: 2 }))
        .addOption("30", this.t("modal.feed.month"))
        .addOption("60", this.t("modal.feed.months", { count: 2 }))
        .addOption("90", this.t("modal.feed.months", { count: 3 }))
        .addOption("180", this.t("modal.feed.months", { count: 6 }))
        .addOption("365", this.t("settings.general.year"))
    ...
    maxItemsSetting.addDropdown((dropdown) => {
      dropdown
        ...
        .addOption("10", this.t("settings.general.items", { count: 10 }))
        .addOption("25", this.t("settings.general.items", { count: 25 }))
        .addOption("50", this.t("settings.general.items", { count: 50 }))
        .addOption("100", this.t("settings.general.items", { count: 100 }))
        .addOption("200", this.t("settings.general.items", { count: 200 }))
        .addOption("500", this.t("settings.general.items", { count: 500 }))
        .addOption("1000", this.t("settings.general.items", { count: 1000 }))
        .addOption("custom", this.t("modal.feed.custom"))
        .setValue(
    ...
    scanIntervalSetting.addDropdown((dropdown) => {
      dropdown
        ...
        .addOption("30", this.t("settings.general.minutes", { count: 30 }))
        .addOption("60", this.t("modal.feed.hour"))
        .addOption("120", this.t("modal.feed.hours", { count: 2 }))
        .addOption("240", this.t("modal.feed.hours", { count: 4 }))
        .addOption("480", this.t("modal.feed.hours", { count: 8 }))
        .addOption("720", this.t("modal.feed.hours", { count: 12 }))
        .addOption("1440", this.t("modal.feed.hours", { count: 24 }))
        .addOption("custom", this.t("modal.feed.custom"))
